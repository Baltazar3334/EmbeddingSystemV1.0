...
#model of the embedding system
MODEL_NAME = "all-MiniLM-L6-v2"

#model of the LLM
MODEL_NAME_LLM = "qwen2.5:7b"
...
#amount of workers to send back ranked from best to worst similarity BY LLM (embedding still happens for all workers)
TOP_N_WORKERS = 20

#how much similarity does a worker need to have to be considered
SIMILARITY_THRESHOLD = 0.3 #not implemented but recommended
